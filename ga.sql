...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 27 feb 2015 kl 11:07
...
`id` int(11) NOT NULL,
  ...
  `bokad` int(1) NOT NULL DEFAULT '0',
  `kund` varchar(30) NOT NULL,
  `kundMail` varchar(30) NOT NULL,
  `kundTelefon` int(30) NOT NULL,
  `behandlingstyp` varchar(30) NOT NULL,
  `bokadDen` date NOT NULL
...
INSERT INTO `tider` (`id`, `starttid`, `sluttid`, `bokad`, `kund`, `kundMail`, `kundTelefon`, `behandlingstyp`, `bokadDen`) VALUES
(4, '2014-05-20 14:00:00', '2014-05-20 15:30:00', 1, '', '', 0, '', '2015-02-27'),
(5, '2014-04-20 14:00:00', '2014-04-20 14:30:00', 0, '', '', 0, '', '0000-00-00'),
(6, '2014-05-20 15:00:00', '2014-05-20 16:30:00', 0, '', '', 0, '', '0000-00-00'),
(7, '2014-05-20 16:00:00', '2014-05-20 17:30:00', 1, 'Sara Andersson', 'sara.andersson@gmail.com', 739528021, '', '2015-02-27'),
(8, '2014-05-20 16:00:00', '2014-05-20 17:30:00', 1, '', '', 0, '', '2015-02-27');
